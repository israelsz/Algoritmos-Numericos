function [mejorError,mejoresCoeficientes,mejorAproximacion,tiempo] = coeficiente9(p,s,x,tol)
...
for m=1:22
    ...
    for k=1:size(matrizCoef,2)
        ...
        a8 = matrizCoef(9,k);
        a9 = matrizCoef(10,k);
        aproximacion = p(a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,x);
    ...
    mejorAproximacion =  p(mejoresCoeficientes(1),mejoresCoeficientes(2),mejoresCoeficientes(3),mejoresCoeficientes(4), mejoresCoeficientes(5),mejoresCoeficientes(6),mejoresCoeficientes(7),mejoresCoeficientes(8),mejoresCoeficientes(9),mejoresCoeficientes(10),x);
